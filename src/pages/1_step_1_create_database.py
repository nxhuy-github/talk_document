...
def create_db_page():
    ...
    def __settings_columns():
        ...
        with col1:
            split_type = st.selectbox("Split type:", TalkDocument.SPLIT_TYPE_LIST)
            repo_id = st.text_input("Repo ID", value=TalkDocument.REPO_ID_DEFAULT)

        with col2:
            embedding_type = st.selectbox("Embedding type", TalkDocument.EMBEDDING_TYPE_LIST, )
            vectorstore_type = st.selectbox("Model VectoreStore Type:", TalkDocument.VECTORSTORE_TYPE_LIST)
    ...
    if "settings" not in st.session_state:
        st.session_state["settings"] = {"split_type": TalkDocument.SPLIT_TYPE_LIST[0],
                                        "embedding_type": TalkDocument.EMBEDDING_TYPE_LIST[0],
                                        "vectorstore_type" : TalkDocument.VECTORSTORE_TYPE_LIST[0],
                                        "repo_id": TalkDocument.REPO_ID_DEFAULT}
    ...
    if "hf_key" not in st.session_state:
            ...
            with col_doc:
                ...
                if create_db_button:
                    ...
                    try:
                        ...
                        switch_page("step_2_ask_documents")
        ...
        with tab_settings:
            ...
            with col_pic2:
                ...
                st.image("images\Application.PNG")
